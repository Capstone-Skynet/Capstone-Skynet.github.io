...
\subsection{Multirotor}\label{multirotor}
\subsubsection{Avionics}\label{avionics}
\input{3_2_1_avionics}

\subsubsection{Drone Power}\label{drone_power}
\input{3_2_2_drone_power}
