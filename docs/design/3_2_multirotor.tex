...
RPAS air frame sizes are commonly referred to by their \textit{motor-to-motor-diagonal-span} (MMDS). The MMDS measures the distance between the pair of motors which are the furthest apart. 
