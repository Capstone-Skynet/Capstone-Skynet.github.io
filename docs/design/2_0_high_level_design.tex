...
\begin{enumerate}
\item Video is captured using the on-board camera, and is transmitted to the PMB via a CSI interface
\item Video is decomposed into individual frames and sent to two locations:
\begin{enumerate}
