...
\begin{enumerate}
\item The on-board camera captures video and transmits it to the PMB via a CSI interface
\item The PMB decomposes the video into individual frames and sends it to two locations:
\begin{enumerate}
