...
The base station retrieves this information by querying a TCP/IP server hosted by the computing platform (Raspberry Pi) and displays the results via a web-application (\textbf{F.BS.1}).
