...
The selected device to implement the platform management system is the Raspberry Pi 4. As seen in Figure \ref{rpi}, the Raspberry Pi 4 is a small single-board computer which hosts a quad-core ARM Cortex A72 CPU, a CSI camera interface, 40 serial pins, WiFi/Bluetooth, and a gigabit Ethernet port. The Raspberry Pi 4 was selected over other single-computer platforms (including Arduino/Beagleboard/Orange Pi) as it:
\begin{itemize}
