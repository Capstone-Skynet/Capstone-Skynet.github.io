BLDC outrunner motors are often given the code YYXX to denote their stator size. Typically, the larger the stator, the slower it spins given the same voltage. This is a linear relationship described by the motor parameter kV:
$$
...
For example, below is a sample set of thrust output using a SunnySky X2216 1250 kV motor using 9.0 inch 5.0 inch pitch and 10.0 inch 4.7 inch pitch propellers obtained from a vendor website \cite{sunnysky-2216}. 
We use this information to make informed decision on motors with appropriate size and KV constants.
