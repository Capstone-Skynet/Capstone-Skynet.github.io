...
\begin{enumerate}[{F.DR}.1\hspace{1cm}]
	\itemsep -0.75em 
	\item The multirotor RPAS shall lfit-off from the ground on its own power without a wired connection.
...
\begin{enumerate}[{F.ML}.1\hspace{1cm}]
	\itemsep -0.75em 
...
\begin{enumerate}[{F.BS}.1\hspace{1cm}]
	\itemsep -0.75em 
...
\subsection{Multirotor RPAS}
\begin{enumerate}[{NF.FP}.1\hspace{1cm}]
	\itemsep -0.75em 
...
\begin{enumerate}[{NF.SR}.1\hspace{1cm}]
	\itemsep -0.75em 
...
\subsection{Cost}
\begin{enumerate}[{C.CT}.1\hspace{1cm}]
	\itemsep -0.75em 
...
\begin{enumerate}[{C.EN}.1\hspace{1cm}]
	\itemsep -0.75em 
