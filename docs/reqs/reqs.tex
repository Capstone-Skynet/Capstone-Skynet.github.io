...
\begin{enumerate}[label=F.CM.\arabic*, wide=1cm, widest=3cm, leftmargin=*, font=\bfseries, noitemsep,topsep=0pt, parsep=4pt, partopsep=0pt]
	\item The Air-Ground communication between base station and computing platfrom shall have a transmission distance of at least 30 meters.
	\item The Air-Ground communication shall be estabilished under IEEE 802.11n protocal.
	\item The Air-Ground communication shall be established automatically.
	\item The Air-Ground communication shall be bi-directional.
\end{enumerate}
