...
\textbf{Manual tests} are tests which \textit{cannot be performed by the device itself} and must therefore be manually performed by a quality controller. These tests are performed less frequently -- some may be executed prior to every flight, while others may only be performed once. 
