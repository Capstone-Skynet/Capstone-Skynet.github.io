...
\input{4_1_2_camera_tests}

\subsubsection{Machine Learning Tests}
\input{4_1_3_ml_tests}
...
\subsection{Video Capture Verification Results}
\begin{table}[H]
	\centering
	\begin{tabular}{llll}
	\hline
	...
	\hline
	T.CAM.1 & F.CAM.1  & PEND   & \\
	T.CAM.2 & F.CAM.2, NF.CAM.6 & PEND   & \\
	T.CAM.3 & NF.CAM.1, NF.CAM.2, NF.CAM.4 & PEND & \\
	\hline
	\end{tabular}
\end{table}

\subsection{Machine Learning Verification Results}
\begin{table}[H]
	\centering
	\begin{tabular}{llll}
	\hline
	\textbf{VR} & \textbf{DR} & \textbf{Status} & \textbf{Eff. Date} \\
	\hline
	T.ML.1 & F.ML.1, F.ML.2, F.ML.3, NF.ML.1, NF.ML.2  & PEND   & \\
	T.ML.2 & F.ML.1, F.ML.2, F.ML.4 & PEND   & \\
	\hline
	\end{tabular}
\end{table}
